export const servicePages = [
  ...
  },
  {
    ...
    title: 'Asesoría energética, luz y gas',
    shortTitle: 'Luz y gas',
    eyebrow: 'Energía',
    description: 'Revisión de facturas de luz y gas, comparación sin compromiso y acompañamiento en contratación como empresa delegada de Fenie Energía en Navarra y País Vasco.',
    hero: 'Revisión de facturas de luz y gas sin compromiso.',
    intro: 'Analizamos tu factura, te explicamos qué estás pagando y valoramos contigo si existe una opción más adecuada para tu consumo. El objetivo es que entiendas la propuesta antes de tomar cualquier decisión.',
    services: ['Comparación de facturas.', 'Revisión de potencia contratada.', 'Explicación de conceptos de la factura.', 'Valoración de alternativas.', 'Acompañamiento en contratación.', 'Atención directa.'],
    process: ['Envías la factura.', 'Revisamos los datos relevantes.', 'Explicamos si hay margen de mejora.', 'Decides sin compromiso.'],
  },
];
