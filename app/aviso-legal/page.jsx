      ...
      <main>
        <section className="bg-neutral-950 pt-32 text-white">
          <div className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
            ...
            <p className="mt-6 text-base leading-8 text-white/65">Información identificativa y condiciones generales de uso de la web de Electricidad Lakuntza.</p>
          </div>
        </section>
          ...
          <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            <div className="rounded-[2rem] border border-neutral-200 bg-white p-7 shadow-card sm:p-10">
              ...
              <p className="mt-10 rounded-2xl bg-neutral-50 p-4 text-xs leading-6 text-neutral-500">
                Última actualización: junio de 2026. Esta página podrá completarse con datos fiscales o registrales adicionales cuando el titular lo facilite para la publicación definitiva.
              </p>
            </div>
          </div>
        </section>
