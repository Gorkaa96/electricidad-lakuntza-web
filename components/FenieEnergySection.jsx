...
export default function FenieEnergySection() {
  return (
    <section id="fenie" className="scroll-mt-24 bg-lakuntza-mist py-20 sm:py-28">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-[2.2rem] border border-neutral-200 bg-white shadow-card">
          <div className="absolute -right-24 -top-24 h-72 w-72 rounded-full bg-lakuntza-green/10 blur-3xl" />
          <div className="absolute -bottom-32 left-10 h-72 w-72 rounded-full bg-neutral-950/5 blur-3xl" />

          <div className="relative grid gap-8 p-7 sm:p-10 xl:grid-cols-12 xl:items-center">
            <div className="xl:col-span-5">
              <Badge><Leaf size={14} /> Feníe Energía</Badge>
              <div className="mt-6 rounded-[2rem] border border-neutral-200 bg-white p-4 shadow-sm sm:p-6">
                <div className="flex min-h-32 items-center justify-center rounded-[1.5rem] bg-neutral-50 p-6 sm:p-8">
                  <img
                    src={fenieLogoUrl}
                    alt="Feníe Energía"
                ...
                <div className="mt-4 rounded-[1.25rem] bg-[#F3FAEF] p-4">
                  <p className="text-xs font-black uppercase tracking-[0.14em] text-lakuntza-greenDark">Empresa delegada</p>
            ...
            <div className="xl:col-span-7">
              ...
              <h2 className="mt-4 max-w-3xl text-4xl font-black leading-[.95] tracking-[-.055em] text-neutral-950 sm:text-5xl">
