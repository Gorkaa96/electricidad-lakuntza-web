...
export default function Footer() {
  return (
    <footer className="bg-neutral-950 pb-28 pt-14 text-white md:pb-14">
      <div className="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-12 lg:px-8">
        <div className="lg:col-span-5">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-white/55">Instalaciones eléctricas · Telecomunicaciones · Energía</p>
            </div>
          </div>
        ...
        <div className="grid gap-8 sm:grid-cols-3 lg:col-span-7">
          <div>
            ...
            <nav className="mt-4 grid gap-3 text-sm font-bold text-white/65">
      ...
      <div className="mx-auto mt-10 max-w-7xl border-t border-white/10 px-4 pt-6 text-xs leading-6 text-white/42 sm:px-6 lg:px-8">
